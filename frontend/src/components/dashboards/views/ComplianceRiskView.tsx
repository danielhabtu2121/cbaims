      ...
      >
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
            ...
            <span style={{ fontSize: '11px', color: '#AEC0D2' }}>Second Line of Defense Scope (§12, §13)</span>
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: '11px', color: '#AEC0D2' }}>Bank Compliance Index</div>
          ...
          <div style={{ textAlign: 'right', borderLeft: '1px solid #1B4580', paddingLeft: '16px' }}>
            <div style={{ fontSize: '11px', color: '#AEC0D2' }}>Open Exceptions</div>
