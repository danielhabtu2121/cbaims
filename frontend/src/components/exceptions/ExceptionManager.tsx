          ...
          <div className="bg-white w-full max-w-xl h-full shadow-2xl flex flex-col overflow-hidden text-xs">
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-4">
              <div className="cims-card p-4 bg-brand-50 border-brand-100 space-y-1">
                <div className="text-[11px] font-bold uppercase text-brand-700 tracking-wider">Exception Description</div>
                <div className="text-text-primary text-xs leading-relaxed">{selectedExc.description}</div>
              </div>

              {selectedExc.status !== 'Resolved' ? (
                <>
                  <div className="space-y-2">
                    <label className="block font-bold text-text-primary">Corrective Action Taken (M)</label>
                    <select
                  ...
                  <div className="space-y-2">
                    <label className="block font-bold text-text-primary">Investigation & Resolution Notes (M)</label>
                    <textarea
                      rows={4}
                  ...
                  <div className="space-y-2 pt-3 border-t border-border">
                    <label className="block font-bold text-text-primary">Escalate Exception To Hierarchy</label>
