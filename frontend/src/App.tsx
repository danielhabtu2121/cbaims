...
export function App() {
  ...
  const effectiveSegment = useMemo(() => {
    ...
    if (userSegmentList.length > 1) {
      return userSegmentList.includes(selectedSegment) ? selectedSegment : userSegmentList[0];
    }
  ...
  return (
    <div className="h-screen bg-brand-50 flex flex-col font-sans text-text-primary overflow-hidden">
      {/* TopBar */}
      <TopBar
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        ...
        {/* Content Area */}
        <main className="flex-1 flex flex-col overflow-y-auto overflow-x-hidden min-w-0 bg-brand-50">
